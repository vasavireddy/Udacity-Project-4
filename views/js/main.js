...
//only gets pizzacontainer value once
...
//set scroll position to 0 and if true, positions of pizzas is being updated
var latestKnownScrollY = 0;
var ticking = true;

// the function called when user scrolls the page. checks the positions of the pizza as the page is being scrolled.
function onScroll() {
  latestKnownScrollY = window.scrollY;
  requestTick();
}

// checks to see if positions of pizzas are being updated. An animation frame is requested if pizza positions are not updating.
...
//updates positions of pizzas and the ticking variable
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  numberOfPizzas = Math.round(window.innerHeight / s) * cols;
